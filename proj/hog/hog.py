...
def gcd(a, b):
    assert a >= 0 and b >= 0, 'Cannot find GCD for non-positives.'
    assert type(a) == int and type(b) == int, 'Invalid datatype to finding GCD.'
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            gain, last_score = score0 - last_score, score0
        else:
            gain, last_score = score1 - last_score, score1
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score + gain, opponent_score) or gain >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score, cutoff = 8.7, num_rolls = 6):
