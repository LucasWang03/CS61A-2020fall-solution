...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while place != beehive:
            ...
            if self.min_range <= distance <= self.max_range and bee != None:
                return bee
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.true_queen_appear:
            self.is_true_queen = False
        else:
            self.is_true_queen = True
            QueenAnt.true_queen_appear = True
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        while place.exit != None:
            place = place.exit
            ant = place.ant
            if ant != None and not ant.buffed:
                ant.damage *= 2
                ant.buffed = True
